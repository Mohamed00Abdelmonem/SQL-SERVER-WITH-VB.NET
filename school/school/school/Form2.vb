...
Public Class Form2
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Dim insertQuery As String = "INSERT INTO Students  (StudentID , FirstName, LastName, Birthdate) VALUES (@StudentID , @FirstName, @LastName, @Birthdate)"
        ...
        Using connection As New SqlConnection(connectionString)
            ...
            Using command As New SqlCommand(insertQuery, connection)
                ' Add parameters
                command.Parameters.AddWithValue("@StudentID", CInt(TextBox1.Text))
