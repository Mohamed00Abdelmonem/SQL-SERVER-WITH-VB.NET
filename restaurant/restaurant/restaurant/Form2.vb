...
Public Class Form2
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Dim insertQuery As String = "INSERT INTO Menus  (MenuID , ItemName , Price) VALUES (@MenuID , @ItemName , @Price)"
        ...
        Using connection As New SqlConnection(connectionString)
            ...
            Using command As New SqlCommand(insertQuery, connection)
                ' Add parameters
                command.Parameters.AddWithValue("@MenuID ", CInt(TextBox1.Text))
                command.Parameters.AddWithValue("@ItemName ", TextBox2.Text)
                command.Parameters.AddWithValue("@Price", CInt(TextBox3.Text))
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Dim deleteQuery As String = "DELETE FROM Menus  WHERE MenuID  = @MenuID"
        ...
        Using connection As New SqlConnection(connectionString)
            ...
            Using command As New SqlCommand(deleteQuery, connection)
                ' Add the parameter
                command.Parameters.AddWithValue("@MenuID", customerIDToDelete)
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        Dim selectQuery As String = "SELECT * FROM Menus "
