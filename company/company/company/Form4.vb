...
Public Class Form4
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Dim insertQuery As String = "INSERT INTO Customers    (CustomerID  , FirstName , LastName, Email , Phone  , EmployeeID  ) VALUES (@CustomerID  , @FirstName , @LastName, @Email , @Phone  , @EmployeeID  )"
        ...
        Using connection As New SqlConnection(connectionString)
            ...
            Using command As New SqlCommand(insertQuery, connection)
                ...
                command.Parameters.AddWithValue("@EmployeeID ", CInt(TextBox6.Text))
